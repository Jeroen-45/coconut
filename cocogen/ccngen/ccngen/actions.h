...
ccn_node *DGCCattribute(ccn_node *);
struct ccn_node *DGMTid(struct ccn_node *node);
struct ccn_node *DGMTienum(struct ccn_node *node);
struct ccn_node *DGMTattribute(struct ccn_node *node);
struct ccn_node *DGMTitravdata(struct ccn_node *node);
struct ccn_node *DGMTsetoperation(struct ccn_node *node);
struct ccn_node *DGMTsetliteral(struct ccn_node *node);
struct ccn_node *DGMTsetreference(struct ccn_node *node);
struct ccn_node *DGMTste(struct ccn_node *node);
struct ccn_node *DGMTchild(struct ccn_node *node);
struct ccn_node *DGMTlifetime_range(struct ccn_node *node);
struct ccn_node *DGMTilifetime(struct ccn_node *node);
struct ccn_node *DGMTinodeset(struct ccn_node *node);
struct ccn_node *DGMTinode(struct ccn_node *node);
struct ccn_node *DGMTipass(struct ccn_node *node);
struct ccn_node *DGMTitraversal(struct ccn_node *node);
struct ccn_node *DGMTiphase(struct ccn_node *node);
struct ccn_node *DGMTiactions(struct ccn_node *node);
struct ccn_node *DGMTast(struct ccn_node *node);
...
ccn_node *DGNUast(ccn_node *);
ccn_node *DGNUast(ccn_node *);
ccn_node *DGNUinode(ccn_node *);
ccn_node *DGNUinode(ccn_node *);
ccn_node *DGNUitraversal(ccn_node *);
ccn_node *DGNUitraversal(ccn_node *);
