...
{CCN_ACTION_TRAVERSAL, CCNAC_ID_DYNAMICGENMARKTRAVERSAL, "dynamicGenMarkTraversal", .traversal = {TRAV_DGMT,},},
...
{CCN_ACTION_TRAVERSAL, CCNAC_ID_DYNAMICGENNAMEUTILITIES, "dynamicGenNameUtilities", .traversal = {TRAV_DGNU,},},
